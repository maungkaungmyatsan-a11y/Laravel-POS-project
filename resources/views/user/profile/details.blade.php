...
<!-- Begin Page Content -->
    <div class="container-fluid">
        ...
        <!-- DataTales Example -->
        <div class="mb-4 shadow card col" style="margin-top: 7rem">
                ...
                <div class="row">
                    <div class="col-3">
                        ...
                        <img class="img-profile img-thumbnail" id="output"
                            src="{{ asset(auth()->user()->profile == null ? 'defaultImage/profile.webp' : 'userProfile/' . auth()->user()->profile)  }}">
                    ...
                    <div class="col">-
                        ...
                        <a href="{{ route('user#changePasswordPage') }}"><i class="mr-2 fa-solid fa-key"></i>Change Password</a><br>
